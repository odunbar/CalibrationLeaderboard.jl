...
# sbatch --parsable -A esm --job-name="pushfwd_l96v" --export=ALL,EXPERIMENT=l96_vec,CALIBRATE_DATE=<yyyy-mm-dd> pushforward_from_posterior.sbatch

# sbatch -A esm --job-name="leaderboard_l96v" --export=ALL,EXPERIMENT=l96_vec,CALIBRATE_DATE=<yyyy-mm-dd> exp_to_leaderboard.sbatch
