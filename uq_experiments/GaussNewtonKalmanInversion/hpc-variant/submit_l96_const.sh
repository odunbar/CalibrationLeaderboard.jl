#!/bin/bash
# Submit preliminaries + calibrate + pushforward + leaderboard for the L96 const-force case.
#
...
echo "=== Submitting pushforward_from_posterior (L96 const-force, after ${CALIB_JID}) ==="
...
# sbatch --parsable -A esm --job-name="pushfwd_l96c" --export=ALL,EXPERIMENT=l96_const,CALIBRATE_DATE=<yyyy-mm-dd> pushforward_from_posterior.sbatch

# sbatch -A esm --job-name="leaderboard_l96c" --export=ALL,EXPERIMENT=l96_const,CALIBRATE_DATE=<yyyy-mm-dd> exp_to_leaderboard.sbatch
