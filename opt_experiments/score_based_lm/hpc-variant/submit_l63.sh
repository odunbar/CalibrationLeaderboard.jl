...
#   sbatch -A esm --array=1-1 --export=ALL,SCRIPT=run_l63_sblm.jl,EXPERIMENT=l63,RUN_DATE=<yyyy-mm-dd>,SCORE_KIND=dsm,BUDGET_MODE=serial run_array.sbatch
#
# full array:
#   sbatch -A esm --array=1-900 --export=ALL,SCRIPT=run_l63_sblm.jl,EXPERIMENT=l63,RUN_DATE=<yyyy-mm-dd>,SCORE_KIND=dsm,BUDGET_MODE=serial run_array.sbatch
#
# leaderboard only:
