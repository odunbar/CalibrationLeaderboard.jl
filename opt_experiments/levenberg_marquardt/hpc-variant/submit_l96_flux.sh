#!/bin/bash
# Submit the Levenberg-Marquardt L96 flux-force pipeline.
...
echo "=== Submitting run_array (L96 flux-force, gradient_descent, after ${PRELIM_JID}) ==="
RUN_JID=$(sbatch --parsable \
                 ...
                 --export=ALL,SCRIPT=run_l96_gradient_descent.jl,EXPERIMENT=l96_flux \
                 run_array.sbatch)
