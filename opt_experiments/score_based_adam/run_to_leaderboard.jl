# score_based_adam — leaderboard netcdf writer
...
#
# Like score_based_lm (and unlike opt_experiments/adam), the ensemble_size axis
# is REAL here (N_ens is the shared budget knob for both budget modes) rather
# than a singleton [1.0].
#
