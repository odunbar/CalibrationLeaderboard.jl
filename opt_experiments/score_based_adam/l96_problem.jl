# score_based_adam — shared L96 problem construction (adapted from score_based_lm).
#
# Extracted so that run_l96_sbadam.jl and any future validation script cannot drift:
