# score_based_adam — L96 preliminaries (identical to levenberg_marquardt's / score_based_lm's, so the
# truth data and hence the leaderboard numbers are directly comparable)
