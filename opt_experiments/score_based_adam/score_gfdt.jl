# score_based_adam — model-agnostic score + GFDT machinery (shared with score_based_lm)
#
# Nothing in this file dispatches on LorenzConfig / EnsembleMemberConfig, so it
# is safe to include from both run_l63_sbadam.jl and run_l96_sbadam.jl (Lorenz63.jl
